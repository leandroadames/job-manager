...
export default function StudentComponents() {
  ...
  const [personalNarrativeInputValue, setPersonalNarrativeInputValue] = useState('');
  ...
  return (
    <div className="flex flex-col justify-start items-center min-h-screen pt-4">
      <div className="p-2 mb-4 h-28 w-1/2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded relative">
        ...
        <p className="absolute top-10 left-2 text-white text-xl font-bold">Resume</p>
      </div>
      ...
      <div className="p-2 mb-4 h-28 w-1/2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded relative">
        ...
        <p className="absolute top-10 left-2 text-white text-xl font-bold">Cover Letter</p>
      </div>
      ...
      <div className="p-2 mb-4 h-28 w-1/2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded relative">
        ...
        <p className="absolute top-10 left-2 text-white text-xl font-bold">Personal Narrative</p>
      </div>
      ...
      <div className="p-2 mb-4 h-28 w-1/2 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded relative">
        ...
        <p className="absolute top-10 left-2 text-white text-xl font-bold">LinkedIn</p>
      </div>
    </div>
  );
}
